...
extension AccountSummaryCell {
    private func setup() {
        ...
        underlineView.backgroundColor = UIColor(named: "color")
        ...
        let chevronImage = UIImage(systemName: "chevron.right")!.withTintColor(UIColor(named: "color")!, renderingMode: .alwaysOriginal)
